...
const ContentPlay = () => {
  ...
  return (
    <div>
      ...
      <div
        className={`flex flex-col gap-5 my-5 w-[250px] mx-auto justify-center h-screen ${
      ...
      >
        {session ? (
          ...
          <Button onClick={handleNewQuiz}>Add quiz</Button>
        )}
        <Button onClick={() => router.push("/play/select-game")}>
          Select Exciting Quiz
        </Button>
      </div>
    </div>
  );
