...
import { ColumnDef, ColumnFiltersState, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, isRowSelected, SortingState, useReactTable, VisibilityState } from "@tanstack/react-table";
...
export const PlayerDataTable = <TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) => {
  // answer data
    ...
    try {
      selected.map(async (player: any) => {
        ...
        toast({
          ...
          description: `players has been deleted.`,
        });
        router.refresh();
      });
    } catch (error) {
